...
- **Pembacaan jumlah offline.** Suara aktif secara default. Setelah operator mengubah **Jumlah** lalu meninggalkan kolom, Nota membacakan kode baris dan jumlah pada baris bernama untuk kode `1A–15AA` serta jumlah `1–48` PCS/LSN. Permintaan terbaru menghentikan suara sebelumnya; nilai di luar batas tetap dapat disimpan tetapi tidak dibacakan. Seluruh klip Ogg sudah dibundel sehingga fitur ini tidak membutuhkan koneksi runtime.
