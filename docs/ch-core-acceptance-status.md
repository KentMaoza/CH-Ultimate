...
| Artifact signed v0.2.2 | PASS | Fresh download: `CH-Ultimate-0.2.2-Setup.exe`, 149268992 bytes, SHA-256 `a1d484804d49ea9bce3b895b628bfb745de8eaa73181d59378a599396e007b40`; `CHU-Companion-Mobile-0.2.2-release.apk`, 43104529 bytes, SHA-256 `496057db78f5a41a3f75adf7c5eef9f878cf33cc5ee9674eb48fa7cb2e1909c9`; checksum manifest lulus; Android package/version/signer dan Windows `ch_ultimate-0.2.2-full.nupkg` diverifikasi |
| Publikasi GitHub | PASS | `pilot-v0.2.2` diterbitkan 2026-08-05T09:57:45Z (17:57:45 WITA), target `dc76d3c0529233974f0d1ec18420a230d0c768a5`; [workflow run 30994408231](https://github.com/KentMaoza/CH-Ultimate/actions/runs/30994408231) `success`; [GitHub prerelease](https://github.com/KentMaoza/CH-Ultimate/releases/tag/pilot-v0.2.2) |
| Core source staging | PASS | NAS `/Volumes/home/CH_Ultimate_Pilot/dc76d3c`: source archive exact commit rilis SHA-256 `55f193d8b483223c322e69312b86a12f90be6f7c42d1da39517ccdd366ca4798`; helper preflight terkoreksi SHA-256 `de55aec640e316fe9dd87c4b9e226cfa6a0d0db3f8b6a94f004b2ef5910d7a6b`; helper prepare aktif SHA-256 `028d6cf8c1f6c6d4bec2bcfe35e3291234688500183e4a9e574fb92751e117c9`; supplement pembanding scratch SHA-256 `f34cf3040757612346e1780a144a0f01ba50a89cdf34b153ace48437ae424b55`; workbook mempertahankan hash yang disetujui; helper lama ditandai `DO-NOT-RUN`; staging belum dijalankan sebagai deploy |
