...
export function MoreView({ coreBacked = false, syncLabel, onOpenPrices, onOpenRecommendations, onOpenDataExport }: { coreBacked?: boolean; syncLabel?: string; onOpenPrices: () => void; onOpenRecommendations: () => void; onOpenDataExport: () => void }) {
  return <section className="mobile-more-view">
    ...
    <div className="mobile-more-list">
      ...
      <button aria-label="Perubahan Harga" onClick={onOpenPrices}><ClockIcon /><span><strong>Perubahan Harga</strong><small>{coreBacked ? `CH Core · Data · ${syncLabel ?? 'Tidak terhubung'}` : 'Lihat riwayat perubahan harga sesi ini.'}</small></span></button>
