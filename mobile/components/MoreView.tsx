...
export function MoreView({ onOpenPrices, onOpenRecommendations }: { onOpenPrices: () => void; onOpenRecommendations: () => void }) {
  return <section className="mobile-more-view">
    ...
    <div className="mobile-more-list">
      ...
      <button aria-label="Perubahan Harga" onClick={onOpenPrices}><ClockIcon /><span><strong>Perubahan Harga</strong><small>Lihat riwayat perubahan harga sesi ini.</small></span></button>
    </div>
  </section>;
}
