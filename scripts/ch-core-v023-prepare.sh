...
release_commit='8a9ffcec972a358ce94270a70f0a1de026c85b84'
archive_root="ch-ultimate-$release_commit"
staging_root='/volume1/homes/kentmaoza/CH_Ultimate_Pilot/8a9ffce'
source_archive="$staging_root/ch-ultimate-$release_commit.tar.gz"
expected_archive_sha256='49e5be9c0b3672012ece35f67850bc3ce6e840669fec6ed9574980de1e652712'
...
target_root='/volume1/docker/ch-ultimate-8a9ffcec972a358ce94270a70f0a1de026c85b84'
receipt="$staging_root/prepare-v023-receipt.txt"
receipt_draft="$staging_root/.prepare-v023-receipt.txt.tmp"
...
{
  printf 'CH_CORE_V023_PREPARE_V1\n'
...
printf 'Prepared exact v0.2.3 source without environment or deployment: %s\n' \
  "$receipt"
