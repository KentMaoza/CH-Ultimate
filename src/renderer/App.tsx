  ...
  return (
    <div className={`app-shell${collapsed ? ' rail-collapsed' : ''}`}>
      ...
      <main className="app-main">
        ...
        {active === 'inventory' ? <InventoryPage /> : active === 'create' ? <CreateSkuPage /> : active === 'label' ? <LabelPage /> : active === 'notaArchive' ? <ArchiveNotaPage view={archiveView} onViewChange={setArchiveView} onOpenNota={openNota} /> : active === 'revenue' ? <RevenuePage /> : active === 'empty' ? <EmptyStockPage /> : active === 'settings' ? <SettingsPage /> : (
