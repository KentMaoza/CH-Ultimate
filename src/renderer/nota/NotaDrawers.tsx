...
export function WorkingDrawer({ transactions, selected, onClose, onSelect, onAdd, onCancelPage, onCancelTransaction, restoreFocusTo, busy = false }: {
  transactions: NotaTransaction[]; selected: Selection; onClose: () => void; onSelect: (selection: Selection) => void; onAdd: (transactionId: string) => void; onCancelPage: (selection: Selection) => void; onCancelTransaction: (transactionId: string, target: HTMLElement) => void; restoreFocusTo: HTMLElement | null; busy?: boolean;
}) {
