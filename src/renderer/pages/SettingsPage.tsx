...
export function SettingsPage({ coreBacked = false }: { coreBacked?: boolean }) {
  ...
  return <div className="feature-page settings-grid">
    ...
    <section className="settings-card dark-card"><span>APLIKASI</span><h2>CH Ultimate 0.1.2</h2><p>{coreBacked ? 'Electron · Node API · MariaDB · Bahasa Indonesia · IDR · WITA' : 'Electron frontend-only · Bahasa Indonesia · IDR · WITA'}</p><hr /><p>{coreBacked ? 'Data bisnis disinkronkan melalui CH Core pada NAS lokal. Auto-update dan printing Nota/template/invoice belum tersedia. Barcode SKU memakai dialog print sistem.' : 'NAS, database, auto-update, mobile, serta printing Nota/template/invoice belum tersedia. Barcode SKU memakai dialog print sistem.'}</p></section>
