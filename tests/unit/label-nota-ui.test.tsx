...
test('completes a lsn nota from the CH Nota workspace and deducts twelve pieces', async () => {
  ...
  fireEvent.click(screen.getByRole('button', { name: '1. Barang dikirim sekarang' }));
  expect(await screen.findByText('Nota berhasil disimpan di Selesai.')).toBeInTheDocument();
